...
export const projects: Project[] = [
    {
        ...
        background: "/images/projects/eggcellent-pomodoro/eggcellent-pomodoro-bg.png",
        bgColor: "#2596be",
        icon: "/images/projects/eggcellent-pomodoro/egg-icon.png",
        status: "completed",
        ...
        scenes: [
            '/images/projects/eggcellent-pomodoro/eggcellent-pomodoro-bg.png',
            '/images/projects/eggcellent-pomodoro/eggcellent-pomodoro-scene1.png',
            '/images/projects/eggcellent-pomodoro/eggcellent-pomodoro-scene2.png',
            '/images/projects/eggcellent-pomodoro/UML_Design_Diagram.png'
        ],
    ...
    },
    {
        ...
        cast: [
            ...
            { name: 'React', role: 'Styling' },
        ],
        scenes: [
            '/images/projects/portfolio-website/kuan-code-scene2.png',
            '/images/projects/portfolio-website/kuan-code-scene1.png',
            '/images/projects/portfolio-website/kuan-code-scene4.png',
            '/images/projects/portfolio-website/kuan-code-scene3.png',
    ...
    },
    {
        ...
        background: "/images/projects/chaotic-order/chaotic-order-bg.png",
        thumbnail: "/images/projects/chaotic-order/chaotic-order-thumb.png",
        status: "in-dev",
        progress: 80,
        ...
        scenes: [
            '/images/projects/chaotic-order/chaotic-order-scene1.png',
        ],
    ...
    },
    {
        ...
        icon: "/images/projects/stock-sense/discord-icon.png",
        year: 2025,
        bgColor: "#0d0b1f",
        ...
        cast: [
            ...
            { name: 'Discord', role: 'Chatbot Interface', icon: "/images/projects/stock-sense/discord-icon.png"},
            { name: 'Ollama', role: 'LLM Framework', icon: "/images/projects/stock-sense/ollama-icon.png" },
            { name: 'ChromaDB', role: 'Database' },
            { name: 'HuggingFace', role: 'Chunking', icon: "/images/projects/stock-sense/huggingface-icon.png" },
        ],
        scenes: [
            '/images/projects/stock-sense/stock-sense-scene1.png',
        ],
    ...
    },
    {
        ...
        featured: true,
        currentlyBuilding: false,
        projectName: "UBC Insight",
        route: "/projects/ubc-insight",
        githubUrl: "https://github.com/gatory/UBC_Insight",
        thumbnail: "/images/projects/ubc-insight/ubc-insight-thumb.png",
        background: "/images/projects/ubc-insight/ubc-insight-bg.png",
        status: "completed",
    ...
    },
    {
        ...
        githubUrl: "https://github.com/gatory/NYC_Airbnb_Analysis",
        writingSample: "/images/projects/nyc-airbnb/NYC_Airbnb_Analysis_Report.pdf",
        background: "/images/projects/nyc-airbnb/nyc-airbnb-scene4.png",
        icon: "/images/projects/nyc-airbnb/airbnb-icon.png",
        status: "completed",
        ...
        cast: [
            ...
            { name: 'Pandas', role: 'Data Engineering' },
            { name: 'NumPy', role: 'Data Engineering' },
            { name: 'Seaborn', role: 'Data Visualization' },
        ],
        scenes: [
            '/images/projects/nyc-airbnb/nyc-airbnb-scene4.png',
            '/images/projects/nyc-airbnb/nyc-airbnb-scene1.png',
            '/images/projects/nyc-airbnb/nyc-airbnb-scene2.png',
            '/images/projects/nyc-airbnb/nyc-airbnb-scene3.png',
        ],
    ...
    },
    {
        ...
        writingSample: "/images/projects/player-analysis/PlaCraft-Player-Analysis-Report.html",
        icon: "/images/projects/player-analysis/player-analysis-icon.png",
        bgColor: "#122E18",
        status: "completed",
        ...
        scenes: [
            '/images/projects/player-analysis/player-analysis-scene1.png',
        ],
    ...
    },
    {
        ...
        githubUrl: "https://github.com/gatory/Asteroid_Database",
        writingSample: "/images/projects/astroid-database/Astroid_Database_Process_Documentation.pdf",
        icon: "/images/projects/astroid-database/astroid-icon.png",
        status: "completed",
        ...
        cast: [
            ...
            { name: 'Oracle', role: 'Relational Database', icon: '/images/projects/astroid-database/oracle-icon.png' },
            { name: 'MySQL', role: 'Relational Database' },
        ],
        scenes: [
            '/images/projects/astroid-database/astroid-database-scene1.png',
        ],
    ...
    },
    {
        ...
        githubUrl: "https://github.com/slim-33/CrispIt",
        thumbnail: "/images/projects/crispit/crispit-thumb.png",
        bgColor: "#152E2C",
        status: "completed",
        ...
        overview: "A mobile application serving as a digital inventory for household refrigerators, prompting users on ingredient expiration timelines and generating smart recipes.",
        runtime: "2 Days",
        cast: [
            { name: 'React Native', role: 'Mobile Framework' },
            { name: 'Gemini', role: 'AI Integration', icon: '/images/projects/crispit/gemini-icon.png' },
            { name: 'MongoDB', role: 'Database'}
        ],
        scenes: [
            '/images/projects/crispit/crispit-scene1.jpg',
            '/images/projects/crispit/crispit-scene2.jpg',
            '/images/projects/crispit/crispit-scene3.jpg',
            '/images/projects/crispit/crispit-scene4.jpg',
            '/images/projects/crispit/crispit-scene5.jpg',
        ],
    ...
    },
    {
        ...
        thumbnail: "/images/projects/jetautopro/jetautopro-thumb.png",
        status: "upcoming",
        progress: 0,

...
export const techItems: TechItem[] = [
    ...
    { name: "React Native", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/reactnative/reactnative-original.svg", brandColor: "#61dafb", faintColor: "rgba(97, 218, 251, 0.02)", glowColor: "rgba(97, 218, 251, 0.15)" },
    ...
    { name: "ChromaDB", icon: "https://raw.githubusercontent.com/FlowiseAI/Flowise/main/packages/components/nodes/vectorstores/Chroma/chroma.svg", brandColor: "#ff6446", faintColor: "rgba(255, 100, 70, 0.02)", glowColor: "rgba(255, 100, 70, 0.15)" },
    { name: "Mocha", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mocha/mocha-plain.svg", brandColor: "#8d6748", faintColor: "rgba(141, 103, 72, 0.02)", glowColor: "rgba(141, 103, 72, 0.15)" },
    { name: "JUnit5", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/junit/junit-original.svg", brandColor: "#25A162", faintColor: "rgba(37, 161, 98, 0.02)", glowColor: "rgba(37, 161, 98, 0.15)" },
    { name: "Jupyter Notebook", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jupyter/jupyter-original.svg", brandColor: "#F37626", faintColor: "rgba(243, 118, 38, 0.02)", glowColor: "rgba(243, 118, 38, 0.15)" },
    { name: "R", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/r/r-original.svg", brandColor: "#276DC3", faintColor: "rgba(39, 109, 195, 0.02)", glowColor: "rgba(39, 109, 195, 0.15)" },
];
